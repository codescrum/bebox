...
describe 'Test 11: Puppet pre apply step' do
  ...
  it 'should generate a Puppetfile' do
    Bebox::Puppet.generate_puppetfile(puppet.project_root, puppet.step, [profile.relative_path])
  ...
  it 'should generate the roles and profiles modules' do
    Bebox::Puppet.generate_roles_and_profiles(puppet.project_root, puppet.step, role.name, [profile.relative_path])
